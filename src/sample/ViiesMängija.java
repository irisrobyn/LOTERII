...
public class ViiesMängija {
    @FXML
    private TextField esimeneNimi;
    @FXML
    private TextField teineNimi;
    @FXML
    private TextField kolmasNimi;
    @FXML
    private TextField neljasNimi;
    @FXML
    private TextField viiesNimi;
    @FXML
    ...
    @FXML
    private TextField piletiteNumbrid3;
    @FXML
    private TextField piletiteNumbrid4;
    @FXML
    private TextField piletiteNumbrid5;

    Main m = new Main();
    List<Mängija> mängijad = new ArrayList<>();
    Loterii loto = new Loterii(1,2);
    ...
    public void mängi(javafx.event.ActionEvent actionEvent) throws IOException {
        ...
        mängijad.add(saanMängija(piletiteNumbrid3,kolmasNimi));
        mängijad.add(saanMängija(piletiteNumbrid4,neljasNimi));
        mängijad.add(saanMängija(piletiteNumbrid5,viiesNimi));
